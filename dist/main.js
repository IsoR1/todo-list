...
const mainTag = function () {
  ...
  const renderTaskContent = (task) => {
    ...
    if ((0,_storage_js__WEBPACK_IMPORTED_MODULE_0__.checkIfCompleted)(projectNum, taskId)) {
  ...
  document.addEventListener('click', (e) => {
    if (e.target.matches('.task-checkbox')) {
      ...
      if (_project_js__WEBPACK_IMPORTED_MODULE_2__["default"][projI].tasks[currentId].completed == false) {
        _project_js__WEBPACK_IMPORTED_MODULE_2__["default"][projI].tasks[currentId].completed = true;
        (0,_storage_js__WEBPACK_IMPORTED_MODULE_0__.updateCompletionStorage)(projectNum, currentId)
      } else if (_project_js__WEBPACK_IMPORTED_MODULE_2__["default"][projI].tasks[currentId].completed == true) {
        _project_js__WEBPACK_IMPORTED_MODULE_2__["default"][projI].tasks[currentId].completed = false;
        (0,_storage_js__WEBPACK_IMPORTED_MODULE_0__.updateCompletionStorage)(projectNum, currentId)
      }
    }
  });
  ...
  const formSubmitAction = (e) => {
    ...
    _task_js__WEBPACK_IMPORTED_MODULE_1__["default"][taskId] = new _task_js__WEBPACK_IMPORTED_MODULE_1__["default"](titleInput, desInput, dateInput, prioInput);
    console.log('task created')
    _project_js__WEBPACK_IMPORTED_MODULE_2__["default"][projectNum].addTask(_task_js__WEBPACK_IMPORTED_MODULE_1__["default"][taskId]);

    (0,_storage_js__WEBPACK_IMPORTED_MODULE_0__.addToStorage)('task', _task_js__WEBPACK_IMPORTED_MODULE_1__["default"][taskId], projectNum);

    renderTaskContent(_task_js__WEBPACK_IMPORTED_MODULE_1__["default"][taskId]);
  ...
  const createProject = (e) => {
    ...
    _project_js__WEBPACK_IMPORTED_MODULE_2__["default"][projectId] = new _project_js__WEBPACK_IMPORTED_MODULE_2__["default"](projectName, projectId);
    renderProject(projectName);

    if (projectId == 0 && !storageArray) {
      (0,_storage_js__WEBPACK_IMPORTED_MODULE_0__.addToStorage)('project', _project_js__WEBPACK_IMPORTED_MODULE_2__["default"][projectId], projectNum);
    }
  ...
  const renderProjectStorage = () => {
    ...
    if (storageArray) {
      storageArray.forEach((el) => {
        projectId = el.id;
        _project_js__WEBPACK_IMPORTED_MODULE_2__["default"][projectId] = new _project_js__WEBPACK_IMPORTED_MODULE_2__["default"](el.name, projectId);
  ...
  document.body.addEventListener('click', (e) => {
    if (e.target.matches('.project-name-p')) {
      ...
      if (_project_js__WEBPACK_IMPORTED_MODULE_2__["default"][projectNum].selected) {
        return;
      }
      
      
      if (!_project_js__WEBPACK_IMPORTED_MODULE_2__["default"][projectNum].tasksRendered) {
        if (taskArray) {
          taskArray.forEach((el) => {
            renderTaskContent(el);
            _project_js__WEBPACK_IMPORTED_MODULE_2__["default"][projectNum].tasks.push(el);
          });
          _project_js__WEBPACK_IMPORTED_MODULE_2__["default"][projectNum].tasksRendered = true;
        }
      }
      ...
      _project_js__WEBPACK_IMPORTED_MODULE_2__["default"][projectNum].selected = true;
      
      let allProjects = document.querySelectorAll(".project-list-div");
      allProjects.forEach(el => {
        if (el.dataset.value !== projectNum) {
          _project_js__WEBPACK_IMPORTED_MODULE_2__["default"][el.dataset.value].selected = false
        }
      })
    }
  ...
  document.addEventListener('click', (e) => {
    ...
    if (e.target.matches('.del-p')) {
     ...
     // find index that corresponds to the selected task element's id
      ...
      ;(0,_storage_js__WEBPACK_IMPORTED_MODULE_0__.removeTaskFromStorage)(projDataId, index);
      _project_js__WEBPACK_IMPORTED_MODULE_2__["default"][projDataId].removeTask(currentTaskId);
      selectedTask.remove();
      taskId--;
      // taskDataId--;
    }
  ...
  document.addEventListener('click', (e) => {
      if (e.target.matches('.project-del')) {
        ...
        if (projectName !== 'Default') {
          ...
          ;(0,_storage_js__WEBPACK_IMPORTED_MODULE_0__.removeProjectFromStorage)(index)
  ...
  dateToday.addEventListener('click', (e) => {
    const endDayDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date());
  ...
  dateWeek.addEventListener('click', (e) => {
    const endOfW = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(new Date());
  ...
  dateMonth.addEventListener('click', (e) => {
    const endOfM = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(new Date());
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (mainTag);
...
/* harmony export */   "checkIfCompleted": () => (/* binding */ checkIfCompleted),
...
/* harmony export */   "updateCompletionStorage": () => (/* binding */ updateCompletionStorage)
/* harmony export */ });
...
/* harmony import */ var _sidebarContent_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./sidebarContent.js */ "./src/sidebarContent.js");
